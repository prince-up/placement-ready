                ...
                <div style={{
                    ...
                    <div style={{ marginTop: 'auto', position: 'relative', zIndex: 2 }}>
                        <div style={{
                            ...
                            <div>
                                <div style={{ fontSize: '1rem', fontWeight: '900', color: 'white' }}>{subject.concepts.length}</div>
                                <div style={{ fontSize: '0.6rem', color: 'var(--text-muted)', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '0.05em' }}>Modules</div>
                            </div>
                            <div>
                                <div style={{ fontSize: '1rem', fontWeight: '900', color: 'white' }}>{subject.mcqs.length}</div>
                                <div style={{ fontSize: '0.6rem', color: 'var(--text-muted)', fontWeight: '800', textTransform: 'uppercase', letterSpacing: '0.05em' }}>MCQs</div>
                            </div>
                        </div>
